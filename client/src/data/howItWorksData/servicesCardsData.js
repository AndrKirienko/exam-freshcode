...
export default [
  {
    icon: `${STATIC_IMAGES_PATH}how_it_works_img/services_icon/g1.svg`,
    ...
    btnTitle: 'Launch a Contests',
    link: '/startContest',
    btnIcon: `${STATIC_IMAGES_PATH}how_it_works_img/services_icon/icon-arrow-long-right.svg`,
  },
  {
    icon: `${STATIC_IMAGES_PATH}how_it_works_img/services_icon/g2.svg`,
    ...
    btnTitle: 'Explore Names For Sale',
    link: '/',
    btnIcon: `${STATIC_IMAGES_PATH}how_it_works_img/services_icon/icon-arrow-long-right.svg`,
  },
  {
    icon: `${STATIC_IMAGES_PATH}how_it_works_img/services_icon/g3.svg`,
