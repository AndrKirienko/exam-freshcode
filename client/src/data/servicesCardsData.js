...
export default [
  {
    icon: `${STATIC_IMAGES_PATH}services_icon/g1.svg`,
    ...
    link: '/startContest',
    btnIcon: `${STATIC_IMAGES_PATH}services_icon/icon-arrow-long-right.svg`,
  },
  {
    icon: `${STATIC_IMAGES_PATH}services_icon/g2.svg`,
  ...
  {
    icon: `${STATIC_IMAGES_PATH}services_icon/g3.svg`,
